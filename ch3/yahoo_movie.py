...
if __name__ == '__main__':
    ...
    if page:
        ...
        with open('movie.json', 'w', encoding='utf-8') as f:
            json.dump(movies, f, indent=2, sort_keys=True, ensure_ascii=False) #indent
    t1=time.clock()
    print((t1-t0)) #0.42829911978095075 0.4383565119193107
    print(0.4383565119193107-0.42829911978095075)